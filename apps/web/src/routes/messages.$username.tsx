...
import { ThreadView, type ThreadMessage, type ThreadVM } from '@vegify/ui/messages'
...
export const Route = createFileRoute('/messages/$username')({
  loader: ({ context, params }) => context.queryClient.ensureQueryData(threadQuery(params.username)),
