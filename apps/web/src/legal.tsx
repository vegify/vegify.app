    ...
    <div className="min-h-screen bg-background text-foreground">
      <header className="border-b border-border">
        <div className="mx-auto flex max-w-3xl items-center justify-between p-4">
          <a href="/" className="font-serif text-2xl font-bold text-primary-dark dark:text-primary-light">
            Vegify
          </a>
      ...
      <main className="mx-auto max-w-3xl px-4 py-10">
        <h1 className="mb-1 font-serif text-4xl font-bold text-primary-dark dark:text-primary-light">{title}</h1>
        <p className="mb-8 text-sm text-muted-foreground">Last updated {updated}</p>
        <article className="flex flex-col gap-4 leading-relaxed [&_a]:text-primary [&_a]:underline [&_h2]:mt-6 [&_h2]:font-serif [&_h2]:text-xl [&_h2]:font-bold [&_li]:ml-5 [&_li]:list-disc [&_ul]:flex [&_ul]:flex-col [&_ul]:gap-1">
          {children}
        </article>
